...
const getAllDonation = searchTerm =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateSingleDonation = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleUserDonationExecute = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.donationDone.findMany({
      where: {
        userId: id,
...
const donationCalculations = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    result.forEach(donation => {
      ...
      if (
        ((_a =
          donation === null || donation === void 0
            ? void 0
            : donation.donationInfo) === null || _a === void 0
          ? void 0
          : _a.category) === 'food'
      ) {
      ...
      if (
        ((_b =
          donation === null || donation === void 0
            ? void 0
            : donation.donationInfo) === null || _b === void 0
          ? void 0
          : _b.category) === 'education'
      ) {
      ...
      if (
        ((_c =
          donation === null || donation === void 0
            ? void 0
            : donation.donationInfo) === null || _c === void 0
          ? void 0
          : _c.category) === 'clothing'
      ) {
      ...
      if (
        ((_d =
          donation === null || donation === void 0
            ? void 0
            : donation.donationInfo) === null || _d === void 0
          ? void 0
          : _d.category) === 'health'
      ) {
      ...
      if (
        ((_e =
          donation === null || donation === void 0
            ? void 0
            : donation.donationInfo) === null || _e === void 0
          ? void 0
          : _e.category) === 'religion'
      ) {
